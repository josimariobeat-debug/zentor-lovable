...
export default function Instalacao() {
  ...
  if (loading) {
    return (
      <div className="flex-1">
        ...
        <div className="px-8 py-6 flex items-center gap-2 text-sm text-neutral-500">
  ...
  if (!store) {
    return (
      <div className="flex-1">
        <TopBar title="Instalação" />
        <div className="px-8 py-6 text-sm text-neutral-500">Nenhuma loja vinculada à sua conta.</div>
      </div>
    );
  }
